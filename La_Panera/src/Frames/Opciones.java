...
public class Opciones extends javax.swing.JFrame {
    ...
    public Opciones() {
        ...
        fac.setText("<html><p>RESTAURANTE LA PANERA </p><p>PERU, PUEBLO LIBRE</p><p>Teléfono:  (01)2615871  </p></html>");
...
// Comprobar si es mayor que 0 para agregarlos a tabla de pedido
    ...
    private void jButton21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton21ActionPerformed
        JOptionPane.showMessageDialog(null, "En el dia de hoy se realizaron" + contador + " ventas. De un total de: " + suma, "LA PANERA", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void jButton28ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton28ActionPerformed
        ...
        if (Integer.parseInt(numMesa2.getText()) == index) {
            JOptionPane.showMessageDialog(null, "La mesa " + index + " tuvo ventas de " + t, "LA PANERA", JOptionPane.INFORMATION_MESSAGE);

        } else {
            JOptionPane.showMessageDialog(null, "La mesa " + index + " no ha realizdo ventas. TOTAL = 0", "LA PANERA", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void jButton23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton23ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "El mesero que mas ventas realizo fue: " + mayor2, "LA PANERA", JOptionPane.INFORMATION_MESSAGE);
